package com.post.notes.modules.backup.backup_drive_service.data_transformers.categories;
...
public class CategoriesTransformer implements BackupDataTransformer {
    public CategoriesTransformer() {
    ...
    public CreateBackupResult toGoogleDriveBackup(Task task,
        ...
        backupSize = categoriesList.getBytes().length;

        String categoriesFolderId = BackupDriveServiceHelper.createFolder(
                driveService,
                BackupDriveService.CATEGORIES_FOLDER_NAME,
                backupRootFolderId
        );
        ...
        try {
            ...
            Log.d("tag", "CategoriesTransformer->toGoogleDriveBackup()->ERROR: " + e.toString());
            return new CreateBackupResult();
        }

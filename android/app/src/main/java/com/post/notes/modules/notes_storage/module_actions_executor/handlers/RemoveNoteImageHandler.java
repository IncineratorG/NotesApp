...
public class RemoveNoteImageHandler implements JSActionHandler {
    ...
    public void handle(ReactApplicationContext context, ReadableMap action, Promise result) {
        ...
        RemoveNoteImagePayload payload = NotesStorageJSActionsPayloads
                .removeNoteImagePayload(payloadMap);
        if (!payload.isValid()) {
            ModuleError error = NotesStorageErrors.badPayload();
            result.reject(error.code(), error.message());
            return;
        ...
        boolean removeResult = AppStorages.get().notesStorage().removeNoteImage(context, payload.noteId(), payload.imageId());

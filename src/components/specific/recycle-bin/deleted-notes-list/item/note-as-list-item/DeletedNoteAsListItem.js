...
const DeletedNoteAsListItem = ({note, categoriesList, onNotePress}) => {
  ...
  return (
    <TouchableNativeFeedback onPress={notePressHandler}>
      <View
...
export default React.memo(DeletedNoteAsListItem);

...
const OrderedNoteAsTextItemCompact = ({
  note,
  expired,
  categoriesList,
  onNoteLongPress,
  ...
  return (
    <TouchableNativeFeedback delayLongPress={100} onLongPress={onNoteLongPress}>
      <View
        style={[
        ...
        <View style={styles.dragFieldContainer}>
          <Icon
            name="drag-indicator"
            size={20}
            color={invert(noteCategoryColor, {
...
export default React.memo(OrderedNoteAsTextItemCompact);

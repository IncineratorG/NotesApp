...
const EditCategoryDialog = ({visible, category, onOkPress, onCancelPress}) => {
  ...
  }, [categoryName, categoryColor, defaultCategory, onOkPress]);
  ...
  const colorPickerColorSelectedHandler = useCallback(({color}) => {
    SystemEventsHandler.onInfo({
      info: 'EditCategoryDialog->colorPickerColorSelectedHandler(): ' + color,
    });
  ...
  useEffect(() => {
    if (category) {
      ...
      setDefaultCategory(category.isDefault);
    }
  }, [category, t]);
  ...
  return (
    <Portal>
      <Dialog visible={visible} onDismiss={onCancelPress}>
        <Dialog.Title>{t('EditCategoryDialog_title')}</Dialog.Title>
        <Dialog.Content>
              ...
              <View style={styles.categoryColorContainer}>
                ...
                <View style={styles.colorTitleContainer}>
                  <Text style={styles.categoryColorTitle}>
                    {t('EditCategoryDialog_colorTitle')}
                  </Text>
                </View>
              ...
              <View style={styles.defaultCheckmarkContainer}>
                ...
                <View style={styles.checmarkTextContainer}>
                  <Text style={styles.checmarkText}>
                    {t('EditCategoryDialog_defaultCheckmarkText')}
                  </Text>
                </View>
              </View>
            </TouchableNativeFeedback>
